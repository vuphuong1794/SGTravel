...
if ($report_id > 0) {
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: Report.php?message=Báo cáo đã được xóa thành công");
        } else {
            // Nếu xóa thất bại, chuyển hướng về trang với thông báo lỗi
            header("Location: Report.php?message=Lỗi khi xóa báo cáo");
        }
    ...
    header("Location: Report.php?message=ID báo cáo không hợp lệ");
}
