  ...
  <div class="container">
    ...
    $sql = "SELECT bc.id, bc.id_dia_diem, bc.noi_dung_bao_cao, bc.id_tai_khoan, 
            ...
            WHERE (bc.noi_dung_bao_cao LIKE '%$search%' 
              ...
              AND DATE(bc.ngay_bao_cao) = CURDATE()
            LIMIT $sd OFFSET $vt";

    // Truy vấn tổng số báo cáo hôm nay
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            echo "<tr>
              ...
              <td>
                <button onclick=\"if(confirm('Bạn có chắc chắn muốn xóa báo cáo này?')) { window.location.href='xoa_report_homnay.php?id=" . urlencode($row["id"]) . "'; }\">Xóa báo cáo</button>
              </td>
            </tr>";
          }
        } else {
